...
var _ol_control_Sidebar_ = function (settings) {
    var defaults = {
        element: null,
        position: 'left'
    }, i, child;
...
_ol_.inherits(_ol_control_Sidebar_, _ol_control_Control_);

_ol_control_Sidebar_.prototype.setMap = function(map) {
    var i, child;
...
_ol_control_Sidebar_.prototype.open = function(id) {
    var i, child;
...
_ol_control_Sidebar_.prototype.close = function() {
...
_ol_control_Sidebar_.prototype._onClick = function() {
...
_ol_control_Sidebar_.prototype._onCloseClick = function() {
    this.close();
};

export default _ol_control_Sidebar_;
